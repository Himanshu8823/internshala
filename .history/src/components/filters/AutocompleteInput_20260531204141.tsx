      ...
      <div className="relative" ref={wrapperRef}>
        ...
        <div className="relative">
          ...
          {isOpen && matched.length > 0 && (
            <ul className="autocomplete-scrollbar absolute left-0 right-0 top-full z-50 mt-1 max-h-52 overflow-y-auto rounded-lg border border-[#E0E0E0] bg-white shadow-lg">
