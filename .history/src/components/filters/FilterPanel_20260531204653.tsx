...
export function FilterPanel({
  ...
  return (
    <aside className="filter-scrollbar bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-5 space-y-5 sticky top-[72px] self-start h-[calc(100vh-88px)] overflow-y-auto pr-2">
