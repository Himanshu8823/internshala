...
export function FilterPanel({
  ...
  return (
    <aside className="bg-white rounded-xl border border-[#EEF2F7] shadow-sm p-5 space-y-5 sticky top-[72px] self-start max-h-[calc(100vh-88px)] overflow-y-auto">
      {/* Header */}
      ...
      {showMore && (
        <div className="space-y-5">
          ...
          {/* ✅ shadcn official Date Picker pattern — Popover + Calendar */}
            ...
            <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className="w-full justify-start text-left font-normal data-[empty=true]:text-muted-foreground border-[#E0E0E0]"
                >
