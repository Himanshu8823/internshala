...
export function FilterPanel({
  ...
  return (
    <aside className="bg-white rounded-lg border border-[#E0E0E0] shadow-sm p-5 space-y-5 sticky top-[72px] self-start h-[calc(100vh-88px)] overflow-y-scroll overscroll-contain pr-2">
