...
export function FilterPanel({
  ...
  return (
    <aside className="filter-scrollbar bg-white rounded-xl border border-[#EEF2F7] shadow-sm p-5 space-y-5 sticky top-[72px] self-start max-h-[calc(100vh-88px)] overflow-y-auto pr-2">
      ...
      {/* Clear all — bottom right, only when filter active */}
      {isAnyFilterActive && (
            ...
            <Popover open={calendarOpen} onOpenChange={setCalendarOpen}>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  id="startingFrom"
                  className="w-full justify-start font-normal border-[#E0E0E0] text-sm text-[#6B7280]"
                >
