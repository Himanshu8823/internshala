...
function getRelativePostedRank(label: string): number {
...
export function InternshipListSection({
  ...
  const sortedFiltered = useMemo(() => {
    ...
    return [...filtered].sort((a, b) => {
      const timestampDiff = b.postedOnDateTime - a.postedOnDateTime;
      if (timestampDiff !== 0) return timestampDiff;

      return getRelativePostedRank(a.postedAt) - getRelativePostedRank(b.postedAt);
    });
  }, [data, filters]);
