...
import { timeAgo, isRelativeTimeString } from '@/lib/utils';
...
export function InternshipCard({ internship }: InternshipCardProps) {
  ...
  const postedLabel = isRelativeTimeString(internship.postedAt)
    ? internship.postedAt
    : timeAgo(internship.postedAt);

  return (
    <article className="bg-white rounded-lg border border-[#E0E0E0] shadow-sm hover:shadow-md transition-shadow duration-200 p-5">
